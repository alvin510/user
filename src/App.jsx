      ...
      <Routes>
        ...
        <Route>
          <Route path="/dashboard" element={<AdminLay />}>
            ...
            />
            <Route
              path="/dashboard/profile-show"
              element={<AdminProfileShow />}
            />
            <Route
              path="/dashboard/pengumuman-add"
              element={<AdminPengumuman />}
            />
            <Route
              path="/dashboard/pengumuman-show"
              element={<AdminPengumumanShow />}
            />
            <Route
              path="/dashboard/pengumuman-edit/:id"
              element={<AdminPengumumanEdit />}
            />
