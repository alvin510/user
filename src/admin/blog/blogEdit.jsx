        ...
        <div className="bg-white rounded-lg shadow-lg p-8 w-full ">
          <form onSubmit={handleEditSubmit} encType="multipart/form-data">
            ...
            <div className="flex flex-wrap mb-4">
              <div className="w-full md:w-1/2 md:pr-2">
                ...
                <select
                  ...
                  className="p-3 block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                >
            ...
            <div className="mb-4">
              ...
              <textarea
                id="narasi2"
                placeholder="Masukkan narasi kedua"
                value={narasi2}
                onChange={handleNarasi2Change}
                className="w-full p-2 border rounded"
              ></textarea>
            </div>
            <button
