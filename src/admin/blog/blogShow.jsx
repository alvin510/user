                ...
                <tr key={blog._id}>
                  ...
                  <td className="px-4 py-2">
                    <button
                      ...
                      onClick={() => openModal(blog, "narasi_1")}
                    >
                      Lihat
                    </button>
                  </td>
                  <td className="px-4 py-2">
                    <button
                      className="text-blue-500 hover:underline"
                      onClick={() => openModal(blog, "narasi_2")}
                    >
                      Lihat
                    </button>
                  </td>
        ...
        {modalOpen && selectedBlog && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-4 rounded-lg">
              ...
              {modalContent === "gambar" && (
                <img
                  src={`http://stmikaelsemarangindah.site/blog/${selectedBlog.gambar}`}
                  alt="Gambar Blog"
