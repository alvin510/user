        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden sm:flex flex-grow text-center justify-center text-white">
            <div className="flex">
              ...
              <div className="flex gap-3">
                <Link to={"/profile"} className="ml-4 text-dark">
                  Profile
                </Link>
                <span>|</span>
              </div>
              <div className="flex gap-3">
                <Link to={"/pengumuman"} className="ml-4 text-dark">
                  Pengumuman
                </Link>
                <span>|</span>
              </div>
              <div className="flex gap-3">
                <Link to={"/blog"} className="ml-4 text-dark">
                  Blog
                </Link>
                <span>|</span>
              </div>
              <Link to={"/media"} className="ml-4 text-dark">
                Media
              </Link>
            </div>
          </div>
