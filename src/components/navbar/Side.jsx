  ...
  return (
    <div className="bg-gray-800 h-full w-64 text-white flex flex-col">
        ...
        <ul className="space-y-2">
          <li>
            <a
              ...
              onClick={toggleJadwalDropdown}
            >
              <BsFillCalendarEventFill className="inline-block mr-2" />
              Jadwal
            </a>
            <ul
              className={`${
                isJadwalDropdownOpen ? "block" : "hidden"
              } bg-gray-700 py-2 pl-4`}
            >
              <li>
                <Link
                  to="/dashboard/jadwal-add"
          ...
          <li>
            ...
            >
              <BsFillGridFill className="inline-block mr-2" />
              Event
            </a>
            <ul
              className={`${
          ...
          <li>
            ...
            >
              <BsFillBellFill className="inline-block mr-2" />
              Pengumuman
            </a>
            <ul
              className={`${
                isAnnouncementDropdownOpen ? "block" : "hidden"
              } bg-gray-700 py-2 pl-4`}
            >
              <li>
                <Link
                  to="/dashboard/pengumuman-add"
                  className="block p-2 hover:bg-gray-600"
                >
                  Tambah Pengumuman
                </Link>
          ...
          <li>
            ...
            >
              <BsFillChatFill className="inline-block mr-2" />
              Blog
            </a>
            <ul
              className={`${
                isBlogDropdownOpen ? "block" : "hidden"
              } bg-gray-700 py-2 pl-4`}
            >
              <li>
                <Link
          ...
          <li>
            <a
              href="#"
              className="block p-2 hover:bg-gray-700"
              onClick={toggleGaleryDropdown}
            >
              <AiFillPicture className="inline-block mr-2" />
              Galery
            </a>
            <ul
              className={`${
                isGaleryDropdownOpen ? "block" : "hidden"
              } bg-gray-700 py-2 pl-4`}
            >
              <li>
                <Link
      ...
      <div className="mt-auto">
        <button onClick={logout} className="block p-2 hover:bg-gray-700">
          <BsBoxArrowRight className="inline-block mr-2" />
          Logout
        </button>
      </div>
    </div>
