      ...
      <div className="mb-4">
        <p className="flex items-center">
          ...
          >
            ...
            <option value="pelayananKemasyarakatan">
            ...
            <option value="penelitianDanPengembangan">
      ...
      {filteredBlogs.length > 0 ? (
        filteredBlogs.map((blog) => (
          <div
            ...
            className="flex flex-col lg:flex-row mt-2 bg-slate-200 p-4 w-full rounded-lg text-left cursor-pointer"
          >
            <div className="h-300 lg:w-1/3 lg:pr-4 lg:mb-0 mb-4">
              <img
                className="w-[200px] h-[100px] mx-auto rounded-lg object-cover items-center"
                src={`http://stmikaelsemarangindah.site/blog/${blog.gambar}`}
                alt={blog.judul}
                onError={(e) => {
            ...
            <div className="lg:w-2/3 flex flex-col justify-between">
              ...
              <div className="text-gray-700 text-sm">{blog.jenis}</div>
            </div>
          </div>
        ))
      ) : (
