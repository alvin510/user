        ...
        {blog && (
          <>
            ...
            <div className="border p-2 rounded-lg">
              <img
                className="w-[900px] h-[500px] mx-auto rounded-lg object-cover items-center"
                src={`http://stmikaelsemarangindah.site/profile/blog/${blog.gambar}`}
                alt="Placeholder"
              />
              <div className="flex gap-2 mt-2">
                ...
                <p className="font-semibold text-xl"> {blog.tanggal}</p>
              </div>
